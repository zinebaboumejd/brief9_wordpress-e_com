...
class Kids_Online_Store_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function kids_online_store_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function kids_online_store_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function kids_online_store_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function kids_online_store_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->kids_online_store_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function kids_online_store_load( $class ) {
