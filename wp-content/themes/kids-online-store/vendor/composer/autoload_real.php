...
class Kids_Online_Store_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function kids_online_store_loadClassLoader($class)
    {
    ...
    public static function kids_online_store_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
