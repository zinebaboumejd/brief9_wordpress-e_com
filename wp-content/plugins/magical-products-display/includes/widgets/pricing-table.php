	...
	protected function register_style_controls() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __( 'List Header Typography', 'magical-products-display' ),
...
*/
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __( 'Currency Typography', 'magical-products-display' ),
...
<div class="tbptitw-main">
    <div class="mpd-pricet-base style-<?php echo esc_attr($mpdpr_product_style); ?>">
        <div class="single-bpto <?php if( $mpdpr_set_feature): ?>bpto-highlight-<?php echo esc_attr($mpdpr_product_style);  endif; ?>">
            <div class="bpto-top">
<?php
